...
<div class="kit-employe-index">
    <p>
        <?= (Yii::$app->user->can('employCreate')) ? Html::a(Html::tag('i', '', ['class' => 'fa fa-fw fa-plus']) . Yii::t('app', ' Add employee '), ['create'], ['class' => 'btn btn-success']) : ''?>
    </p>
    ...
    <div class="box">
        ...
        <h3 class="box-title pull-right"><?=Yii::t('app','Employees list')?></h3>
        </div><!-- /.box-header -->
        <?= GridView::widget([
            'dataProvider' => $dataProvider,
