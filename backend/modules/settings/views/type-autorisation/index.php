...
/* @var $searchModel common\models\KitTypeAutorisationSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Types d\'autorisation');
...
?>
<div class="kit-type-autorisation-index">
    <p>
        <?= Html::a(Html::tag('i', '', ['class' => 'fa fa-fw fa-plus']) . Yii::t('app', 'Ajouter un type d\'autorisation'), ['create'], ['class' => 'btn btn-success']) ?>
    </p>
    ...
    <div class="box">
        <div class="box-header with-border">
            ...
            <h3 class="box-title pull-right"><?=Yii::t('app','Liste des types d\'autorisation')?></h3>
        </div><!-- /.box-header -->
        <?= GridView::widget([
            'dataProvider' => $dataProvider,
