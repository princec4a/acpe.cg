...
$this->title = Yii::t('app', 'Modification Type d\'U.O : '.$model->code, [
    'name' => $model->code,
]);
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Type d\'U.O'), 'url' => ['index']];
    ...
    <div class="col-md-8">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><?=Yii::t('app', 'Modifier un type d\'unité organisationnelle')?></h3>
            </div>
            <div class="box-body">
                <?= $this->render('_form', [
                    'model' => $model,
