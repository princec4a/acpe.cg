...
/* @var $searchModel common\models\KitReportSearch */
...
?>
<div class="kit-report-index">

    <p>
        <?= Html::a(Html::tag('i', '', ['class' => 'fa fa-fw fa-plus']) . Yii::t('app', 'Create Report'), ['create'], ['class' => 'btn btn-success']) ?>
    </p>
    ...
    <div class="box">
        <div class="box-header with-border">
            ...
            <h3 class="box-title pull-right"><?=Yii::t('app','Reports')?></h3>
        </div><!-- /.box-header -->
        <?= GridView::widget([
            'dataProvider' => $dataProvider,
