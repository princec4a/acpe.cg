...
/* @var $modelsOptionValue common\models\KitElementTypeAutorisation [] */

$this->title = Yii::t('app', 'Type Autorisation');
    ...
    <div class="col-md-8    ">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><?=Yii::t('app', 'Ajouter les pièces à fournir pour un type d\'autorisation')?></h3>
            </div>
            <div class="box-body">
                <?= $this->render('_form', [
                    'model' => $model,
