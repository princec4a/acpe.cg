<div style='width: 100%; font-size: 13px;'>
    <div style='float: left; width: 30%;padding: 0;margin: 0;'><img src="<?=$logo;?>" style="width: 100%;"></div>
    <div style='float: left; width: 45%; height: 10%; border-top: 1px solid #ffffff;'>
        <div style="background-color:#000;margin-top: 10%; height: 5%;">&nbsp;</div>
    </div>
    <div style='float: left; width: 25%;margin: 0;'>
        <div style='margin: 10px;border: 1px solid #000; height: 12%; text-align: center;'>Photo d'identité</div>
    </div>
    <div style='float: left; width: 70%; text-transform: uppercase; text-align: center;font-weight: bold; font-size: 16px;'>DEMANDE D'<?=$model->typeAutorisation->libelle?></div>
    ...
    <div style='float: left; width: 36%; margin: 0 0 10px 0;'>
        <label>Email</label>
        <div style='width: 100%; border: 1px solid #000; padding-left: 5px'><?=$rccm?></div>
    </div>
    <div style='float: left; width: 2%'>&nbsp;</div>
    ...
    <div style='float: left; width: 100%; margin: 5px 0; font-weight: bold;'>Nous sollicitions une <?=$model->typeAutorisation->libelle?> pour : </div>
    ...
    <div style='float: left; width: 25%'>
        ...
        <div style='width: 100%; border: 1px solid #000; padding-left: 5px'><?=$model->employe->kitPersonneIdentites[0]->typePiece->libelle?></div>
    </div>
    <div style='float: left; width: 2%'>&nbsp;</div>
    ...
    <div style='float: left; width: 33%;border: 1px solid #000;height: 20%; margin: 10px 0 0 0; padding: 0 0 5px 0;'>
    ...
    <div style='float: left; width: 33%;border: 1px solid #000;height: 20%; padding: 0 0 5px 0;'>
